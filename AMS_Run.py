...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            cursor.execute(sql)  # for creating a table
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                try:
                    ...
                    csv_name = 'D:/TYCS per/project/final/Face-Recognition-Attendance-System-main/Attendance/'+DB_table_name+'.csv'
                    ...
                    # Display the CSV data in a new window
                    import tkinter
                    root = tkinter.Tk()
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:\TYCS per\project\final\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    ...
                    Notifica.configure(
                        text="Model not found, Please train model", bg="red", fg="black", width=33, font=('times', 15, 'bold'))
                ...
                date_for_DB = datetime.datetime.fromtimestamp(ts).strftime('%Y_%m_%d')
                DB_Table_name = Subject + "_" + date_for_DB + "_Time_" + Hour + "_" + Minute + "_" + Second
                ...
                # Create table with a safer table name
                ...
                try:
                    cursor.execute(sql)  # Create table if it doesn't exist
                    cursor.execute(insert_data, VALUES)  # Insert data into the table
                ...
                root.configure(background='grey80')
                cs = 'D:/TYCS per/project/final/Face-Recognition-Attendance-System-main/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"D:\TYCS per\project\final\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check attendance-------"')
    ...
    def log_in():
        ...
        if username == 'amin':
            if password == 'amin123':
                ...
                cs = 'D:/TYCS per/project/final/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
